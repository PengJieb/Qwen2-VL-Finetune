...
out_dir=output_local/vision_test_32_32_32_32_token_dynamic_full_crema_policy_random
...
export PYTORCH_DISTRIBUTED_USE_OLD_C10D_API=1

deepspeed --master_port 25901 src/train/eval_sf_ddp.py \
    --use_liger True \
    --lora_enable True \
    --vision_lora False \
    --use_dora False \
    --deepspeed scripts/ds_eval_config.json \
    --lora_namespan_exclude "['lm_head', 'embed_tokens', 'm_qformer']" \
    --lora_rank 64 \
    --lora_alpha 64 \
    --lora_dropout 0.05 \
